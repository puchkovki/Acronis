...
## **Solution**
At first we should test an input value whether it is number and not overflowing long long type. Then we are moving to the checking for number's divisibility by 3 and 5.
